...
m1 = 5.97219e24  # Massa del primo corpo (es. Terra)
m2 = 1.98847e30  # Massa del secondo corpo (es. Sole)
r1 = 1.471e11
v0 = 30290
...
def metodo_heun_bid(t0, y0, N, dt, callback):
    t = t0
    y = np.array(y0)
    print(y)
    for n in range(N):
        ...
        t += dt
        #yield np.array([r1_next, v1_next, theta1_next, omega1_next, r2_next, v2_next, theta2_next, omega2_next])
        callback(r1_next, v1_next, theta1_next, omega1_next, r2_next, v2_next, theta2_next, omega2_next)
